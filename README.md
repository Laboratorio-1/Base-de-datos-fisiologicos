La siguiente tabla es un conjunto de datos de un estudio médico o de investigación relacionado con la presión arterial y el ritmo cardíaco de varios sujetos. 
TABLA:
